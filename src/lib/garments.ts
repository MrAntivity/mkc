...
export const TEE_COLORS: PhotoColor[] = [
  ...
  { id: "antiqueSapphire", label: "Antique Sapphire", swatchHex: "#1b6ca8", image: "/products/classic-tee/antique-sapphire.webp" },
  { id: "azalea", label: "Azalea", swatchHex: "#ec4899", image: "/products/classic-tee/azalea.webp" },
  { id: "berry", label: "Berry", swatchHex: "#7c2855", image: "/products/classic-tee/berry.webp" },
  { id: "blackberry", label: "Blackberry", swatchHex: "#3b1f3d", image: "/products/classic-tee/blackberry.webp" },
  { id: "blueDusk", label: "Blue Dusk", swatchHex: "#3b4a6b", image: "/products/classic-tee/blue-dusk.webp" },
  { id: "brownSavana", label: "Brown Savana", swatchHex: "#8b6f47", image: "/products/classic-tee/brown-savana.webp" },
  { id: "cobalt", label: "Cobalt", swatchHex: "#2d4fc4", image: "/products/classic-tee/cobalt.webp" },
  { id: "coralSilk", label: "Coral Silk", swatchHex: "#f88379", image: "/products/classic-tee/coral-silk.webp" },
  { id: "dustyRose", label: "Dusty Rose", swatchHex: "#c48793", image: "/products/classic-tee/dusty-rose.webp" },
  { id: "electricGreen", label: "Electric Green", swatchHex: "#00c853", image: "/products/classic-tee/electric-green.webp" },
  { id: "garnet", label: "Garnet", swatchHex: "#6e0d25", image: "/products/classic-tee/garnet.webp" },
  { id: "heatherMilitaryGreen", label: "Heather Military Green", swatchHex: "#5f6b4a", image: "/products/classic-tee/heather-military-green.webp" },
  { id: "heatherNavy", label: "Heather Navy", swatchHex: "#3b4559", image: "/products/classic-tee/heather-navy.webp" },
  { id: "heatherRadiantOrchid", label: "Heather Radiant Orchid", swatchHex: "#b565a7", image: "/products/classic-tee/heather-radiant-orchid.webp" },
  { id: "heatherRed", label: "Heather Red", swatchHex: "#b33a3a", image: "/products/classic-tee/heather-red.webp" },
  { id: "heatherSapphire", label: "Heather Sapphire", swatchHex: "#4a7ba6", image: "/products/classic-tee/heather-sapphire.webp" },
  { id: "heliconia", label: "Heliconia", swatchHex: "#e6007e", image: "/products/classic-tee/heliconia.webp" },
  { id: "lime", label: "Lime", swatchHex: "#a4d65e", image: "/products/classic-tee/lime.webp" },
  { id: "midnight", label: "Midnight", swatchHex: "#1b1b2f", image: "/products/classic-tee/midnight.webp" },
  { id: "natural", label: "Natural", swatchHex: "#ece0c8", image: "/products/classic-tee/natural.webp" },
  { id: "neonGreen", label: "Neon Green", swatchHex: "#39ff14", image: "/products/classic-tee/neon-green.webp" },
  { id: "offWhite", label: "Off White", swatchHex: "#f2ede1", image: "/products/classic-tee/off-white.webp" },
  { id: "russet", label: "Russet", swatchHex: "#7c4a3a", image: "/products/classic-tee/russet.webp" },
  { id: "safetyGreen", label: "Safety Green", swatchHex: "#c7f439", image: "/products/classic-tee/safety-green.webp" },
  { id: "safetyOrange", label: "Safety Orange", swatchHex: "#ff6600", image: "/products/classic-tee/safety-orange.webp" },
  { id: "safetyPink", label: "Safety Pink", swatchHex: "#ff6ec7", image: "/products/classic-tee/safety-pink.webp" },
  { id: "sunset", label: "Sunset", swatchHex: "#fa8072", image: "/products/classic-tee/sunset.webp" },
  { id: "tangerine", label: "Tangerine", swatchHex: "#f28500", image: "/products/classic-tee/tangerine.webp" },
  { id: "tennesseeOrange", label: "Tennessee Orange", swatchHex: "#ff8200", image: "/products/classic-tee/tennessee-orange.webp" },
  { id: "tropicalBlue", label: "Tropical Blue", swatchHex: "#00b4d8", image: "/products/classic-tee/tropical-blue.webp" },
  { id: "turfGreen", label: "Turf Green", swatchHex: "#2e6f40", image: "/products/classic-tee/turf-green.webp" },
  { id: "tweed", label: "Tweed", swatchHex: "#a89a7c", image: "/products/classic-tee/tweed.webp" },
  { id: "yellowHaze", label: "Yellow Haze", swatchHex: "#f5e13d", image: "/products/classic-tee/yellow-haze.webp" },
].map((c) => ({ ...c, image: withBasePath(c.image) }));
